      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          <div className="col-span-2 lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-white/70 hover:text-fintech-teal transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-white/70 hover:text-fintech-teal transition-colors">Global Payments</a></li>
              <li><a href="#" className="text-white/70 hover:text-fintech-teal transition-colors">Multi-Currency Accounts</a></li>
              <li><a href="#" className="text-white/70 hover:text-fintech-teal transition-colors">Business Cards</a></li>
              <li><a href="#" className="text-white/70 hover:text-fintech-teal transition-colors">Expense Management</a></li>
              <li><a href="#" className="text-white/70 hover:text-fintech-teal transition-colors">API Integration</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-white/70 hover:text-fintech-teal transition-colors">About Us</a></li>
        ...
        <div className="mt-12 pt-6 border-t border-white/20 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="#" className="text-white/70 hover:text-fintech-teal transition-colors text-sm">Terms</a>
            <a href="#" className="text-white/70 hover:text-fintech-teal transition-colors text-sm">Privacy</a>
